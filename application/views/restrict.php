<section style="min-height: calc(100vh - 83px)" class="light-bg">
  ...
  <div class="container">
    ...
    <ul class="nav nav-tabs">
      <li class="active"><a href="#tab_team" role="tab" data-toggle="tab">Vendedores</a></li>
      <li><a href="#tab_user" role="tab" data-toggle="tab">Usuários</a></li>
    </ul>

    <div class="tab-content">
      <div id="tab_courses" class="tab-pane">
         <div class="container-fluid">
          <h2 class="text-center"><strong>Gerenciar Cursos</strong></h2>
          <a id="btn_add_course" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Produto</i></a>
      ...
      <div id="tab_team" class="tab-pane active">
        <div class="container-fluid">
          <h2 class="text-center"><strong>Gerenciar Vendedores</strong></h2>
          <a id="btn_add_member" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Vendedor</i></a>
      ...
      <div class="modal-body">
        <form id="form_course">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input type="number" step="1" id="course_duration" name="course_duration" class="form-control">
              <span class="help-block"></span>
            </div>
          </div>
